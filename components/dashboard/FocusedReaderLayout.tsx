...
export default function FocusedReaderLayout() {
  return (
    <div className="min-h-screen bg-[#f4f0e7] text-[#10291f]">
      <a
        className="fixed left-3 top-3 z-[200] -translate-y-40 rounded-lg bg-white px-3.5 py-2.5 font-bold text-[#09251c] shadow-md transition-transform focus:translate-y-0 focus:outline-none focus:ring-2 focus:ring-[#c49552]"
