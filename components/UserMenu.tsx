          ...
          <div className="py-1">
            ...
            {isAuthenticated && (
              ...
              >
                ...
                <span className="text-xs font-medium text-gray-800 group-hover:text-orange-600">Reading Challenge</span>
              </NavLink>
            )}
            ...
            {isAuthenticated && (
              ...
              >
                ...
                <span className="text-xs font-medium text-gray-800 group-hover:text-orange-600">Downloads</span>
              </NavLink>
            )}
