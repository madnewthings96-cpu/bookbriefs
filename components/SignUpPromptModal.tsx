        ...
        <div className="p-6 md:p-8">
          ...
          <div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <span className="font-semibold text-gray-900 text-sm md:text-base">{t('pdfDownloads') || 'PDF Downloads:'}</span>
          ...
          <div className="space-y-2 md:space-y-3">
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 md:space-x-3 px-4 md:px-6 py-2.5 md:py-3 bg-white border-2 border-gray-300 rounded-lg hover:bg-gray-50 transition-colors font-medium text-gray-700 text-sm md:text-base"
            >
            ...
            <button
              onClick={handleSignUp}
              className="w-full flex items-center justify-center space-x-2 md:space-x-3 px-4 md:px-6 py-2.5 md:py-3 rounded-lg font-medium text-white transition-colors text-sm md:text-base"
