    ...
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      {googleLogin && onGoogleLogin && (
        <>
          ...
          >
            <button
              className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-hidden hover:cursor-pointer disabled:opacity-50'
              type='button'
