          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <nav className="ml-10 flex items-center space-x-1">
                ...
                <NavLink to="/community" className={linkStyle} style={({ isActive }) => isActive ? activeLinkStyle : undefined}>
                  Community
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-white transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200"></span>
                </NavLink>
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-white/10" id="mobile-menu">
          <div className="px-4 pt-2 pb-3 space-y-1">
            ...
            <NavLink to="/community" className="text-gray-300 hover:bg-white/5 hover:text-white block px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200" style={({ isActive }) => isActive ? activeLinkStyle : undefined} onClick={() => setIsMenuOpen(false)}>Community</NavLink>
