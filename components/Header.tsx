    ...
    () => ({
      ...
      learn: {
        ...
        items: [
          ...
          {
            to: '/connections',
            label: 'Ideas in the wild',
            description: 'See how books explain the patterns shaping decisions, markets, and everyday life.',
            icon: Network,
          },
          {
            to: '/about',
        ...
        feature: {
          ...
          author: 'Books as lenses',
          insight: 'One situation. Several perspectives. A sharper way to see what is happening.',
