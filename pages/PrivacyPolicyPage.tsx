...
const PrivacyPolicyPage: React.FC = () => {
  useSEO({
    title: 'سياسة الخصوصية - تحليل | Privacy Policy - Ta7leel',
    description: 'سياسة الخصوصية لموقع تحليل (Ta7leel). تعرف على كيفية جمعنا واستخدامنا وحمايتنا لبياناتك الشخصية.',
    keywords: 'سياسة الخصوصية, privacy policy, تحليل, ta7leel, حماية البيانات',
    type: 'website',
  });
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 sm:p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none" dir="rtl" style={{ textAlign: 'right' }}>
            ...
            <p><strong>آخر تحديث: 14 سبتمبر 2026</strong></p>
            <p>
              أهلاً بك في موقع تحليل ("www.ta7leel.pro"). نحن في تحليل نقدر خصوصيتك ونلتزم بحماية بياناتك الشخصية. توضح سياسة الخصوصية هذه كيفية جمعنا واستخدامنا وحمايتنا للمعلومات التي نحصل عليها منك عند استخدامك لموقعنا وخدماتنا، والتي تشمل ملخصات الكتب، والمدونات، والأدوات المالية مثل حاسبة حجم الصفقات.
            </p>
            <p>
              تشرح هذه الصفحة ممارساتنا وخياراتك. عندما تكون الموافقة مطلوبة، قد تعرض لك أدوات الموافقة خيارات قبل أن تستخدم خدمات الإعلانات تقنيات التخزين ذات الصلة.
            </p>
            ...
            <ul style={{ paddingRight: '1.5rem', marginBottom: '1.5rem' }}>
              <li style={{ marginBottom: '1rem' }}>
                ...
                <ul style={{ paddingRight: '1.5rem', marginTop: '0.5rem' }}>
                  <li style={{ marginBottom: '0.3rem' }}><strong>Firebase (من Google):</strong> لإدارة مصادقة المستخدمين وتخزين بيانات الحساب، كما نستخدم <strong>Firebase Storage</strong> لتخزين صور مقالات الأخبار المنشورة والمسودات التي يرفعها المشرف.</li>
            ...
            <h2 style={{ color: '#2F4F4F', fontSize: '1.8rem', marginTop: '2rem', marginBottom: '1rem' }}>
              4. الإعلانات وملفات الارتباط وخياراتك
            </h2>
            <p>
              نستخدم Google AdSense لعرض الإعلانات. قد تستخدم Google وشركاؤها cookies أو local storage ومعلومات مثل عنوان IP ونوع الجهاز ونشاط التصفح لقياس الإعلانات، والحد من تكرارها، ومنع الاحتيال، وعرض إعلانات personalized أو non-personalized بحسب إعداداتك والمنطقة التي توجد فيها.
            </p>
            <p>
              قد تعرض Google Privacy &amp; Messaging عناصر تحكم consent في المناطق التي تتطلب ذلك. الخيارات التي تظهر لك وطريقة استخدام Google للبيانات تديرها Google وفق إعدادات الناشر والمنطقة؛ لا نزعم أن مجرد استخدام الموقع يعني أنك وافقت على الإعلانات المخصصة.
            </p>
            <p>
              يمكنك قراءة{' '}
              ...
              ومراجعة أو تغيير خيارات الإعلانات في{' '}
            ...
            <p>
              ...
              <br />
              <strong style={{ color: '#FF7F50' }}>info@ta7leel.pro</strong>
            </p>
          </div>
        </div>
      </div>
