...
export const book: BookDefinition = {
    ...
    summary: `# THE MARKET WIZARDS MASTERCLASS: A DEFINITIVE SYNTHESIS
**The Universal Principles of Peak Performance Trading**
**Role**: Financial Analyst & Trading Psychologist
**Source Material**: *Market Wizards* (Original Volume) by Jack D. Schwager
