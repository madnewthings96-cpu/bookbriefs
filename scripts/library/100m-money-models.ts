...
export const book: BookDefinition = {
    ...
    author: 'Alex Hormozi',
    category: 'Business',
    coverImageUrl: "/images/100m money models.jpg",
    rating: 4.63,
    ratingsCount: "700+",
    ...
    summary: `# A Deep Dive into "$100M Money Models"
...
2. **Phase 2 (The Machine)**: You pour fuel into the vehicle. You build the Acquisition Engine and the Conversion Protocol. You optimize the Cash Conversion Cycle so growth funds itself.

3. **Phase 3 (The Empire)**: You replace the driver. You hire Talent and install Systems so the vehicle drives itself. You focus on EBITDA Multiples and Risk Reduction.
