...
export const book: BookDefinition = {
    ...
    summary: `# INTERNAL DOCUMENT: TRADING MASTERY & DEVELOPMENT PROGRAM
**From**: The Desk of the Managing Partner
**To**: Junior Traders & Trainees
**Subject**: The Roadmap to "One Good Trade" – Your Survival and Success Manual
**Based on *One Good Trade* by Mike Bellafiore**
...
We do not trade random stocks. We trade **Stocks In Play**. These are stocks that, on this specific day, have a reason to move independently of the broader market. We require volatility and liquidity.
To find these, you must hunt for catalysts:
...
From the hundreds of news items, you must distill a **Focus List** of 4 to 6 stocks.
**Criteria**:
...
The amateur says, "I think NVDA is going up." The professional builds a matrix.
For every stock on your Focus List, you must map out specific levels and scenarios before the bell rings.
...
You must write down scripts for your trades.
