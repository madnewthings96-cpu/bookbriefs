...
1. **Maximize Tax-Advantaged Accounts First:** Fund all available tax-advantaged vehicles (e.g., 401(k), IRA, HSA) to the maximum legal limit. The tax savings are the highest guaranteed return available.

2. **Use Four Specific, Ultra-Low-Cost Index Funds:** Construct the equity portion of the portfolio using a simple, diversified basket of four core, low-cost index funds that together represent the global market:
...
3. **Set the Initial Asset Allocation and Automate Contributions:** Determine the allocation (e.g., 90% stocks, 10% bonds for a young investor) and set up automatic payroll deductions or bank transfers. Automate the process to eliminate the dangerous temptation of market timing.

4. **Rebalance Annually (and Only Annually):** Once a year, adjust the portfolio back to the target allocation. This forces the investor to systematically sell high and buy low (selling off the winners that have grown past the target weight and buying the underperforming assets). Do nothing else in between.
...
1. **Index, Don't Trade (The Folly of Prediction):** Recognize the empirical truth of the EMH. Do not attempt to pick individual stocks or time the market, as this is a statistically futile and costly endeavor.

2. **Minimize Fees, Maximize Return (The Cost Imperative):** Treat fees and taxes as guaranteed subtractions from future wealth. The greatest return enhancer is the aggressive minimization of all costs by exclusively using ultra-low-cost index funds and tax-advantaged accounts.

3. **Diversification is Non-Negotiable (The Only Free Lunch):** Spread risk across thousands of global securities (U.S., International, Emerging Markets) and asset classes (stocks, bonds, real estate) to eliminate unsystematic risk.

4. **Time is Your Best Asset (The Compounding Rule):** Start early and remain patient. The power of compounded growth over decades is the primary engine of wealth accumulation.

5. **Rebalance, Don't Panic (The Discipline Imperative):** Establish a simple, appropriate asset allocation and maintain it through a mechanical, periodic rebalancing schedule. Discipline, not genius, is the key to long-term success.
