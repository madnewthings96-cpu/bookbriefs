...
export const book: BookDefinition = {
    ...
    summary: `# Deep-Dive Analysis and Trading Masterclass: The Jesse Livermore Methodology
...
| Feature | The Speculator | The Gambler |
| :--- | :--- | :--- |
| **Approach** | Business requiring study & system | Hope, tips, and thrill |
| **Method** | Records data, identifies trends | Buys haphazardly |
| **Risk** | Calculated and measured | Blind chance |
| **Goal** | Capture the **Major Move** | The "Jackpot" |
...
| :--- | :--- | :--- |
| **Reversal Pivotal Point** | Signals the end of a major trend. | Stock fails to make a new high, then breaks below a key support level. |
| **Continuation Pivotal Point** | Signals the resumption of a trend after a rest. | Stock breaks out **above** the high of a consolidation range. |
...
2.  **Probe 2 (Confirmation)**: If it moves up to $102, buy **30%** more.
3.  **Probe 3 (The Commitment)**: If it moves to $104, buy the final **50%**.
