...
1.  **Technology:** The hardware, software, broker execution, and internet speed.
2.  **Strategy:** The statistical edge (e.g., ABCD patterns, Reversals, VWAP).
3.  **Psychology:** The emotional discipline to execute #2 using #1.
...
**The "Stool Audit"**
Take a piece of paper and draw three columns: Tech, Strategy, Psych.
...
## Key Terminology
**Intrinsic vs. Extrinsic Motivation:** Extrinsic is money/cars (fleeting). Intrinsic is freedom/autonomy (enduring).
**The "Dip":** The inevitable period in a trader's journey where effort is high, but results are negative. This is where 90% of traders quit.

## Real-World Examples
The authors contrast two traders. Trader A wants "to get rich quick to buy a Lamborghini." Trader B wants "to generate income remotely so they can care for an ailing parent and never miss a family moment."
When Trader A hits a drawdown, they quit because the Lamborghini seems impossible. When Trader B hits a drawdown, they persist because the welfare of their parent is non-negotiable. The "Big Why" acts as armor during the drawdown.
...
**Confirmation Bias:** Seeking only news or chart signals that support your current position while ignoring warning signs.
**The Gambler’s Fallacy:** Believing a stock "has to" go up because it has gone down for three days in a row.
**FOMO (Fear Of Missing Out):** Entering a trade late because you see green candles and feel "left behind."
...
## Key Terminology
**Dunning-Kruger Effect:** Cognitive bias where people with low ability overestimate their competence. (The "Beginner's Luck" phase).
**Imposter Syndrome:** The persistent inability to believe that one's success is deserved or has been legitimately achieved as a result of one's own efforts or skills.
**The Valley of Despair:** The low point after the Dunning-Kruger peak, where the trader realizes how much they don't know.
...
**The "Stop-Trading" Rule:** A hard rule to walk away not based on money lost, but on mental energy depleted.
...
## Key Terminology
**The Pre-Market Routine:** A ritualized set of actions performed before the market opens to prime the brain.
**The Journaling Habit:** The act of recording data to create a feedback loop.
**Physiological Priming:** Sleep, diet, and exercise as trading tools.

## Real-World Examples
Aziz outlines his personal morning routine:
1.  Wake up early (sets discipline).
2.  Exercise/Run (burns off cortisol/anxiety).
3.  Cold shower (wakes up the nervous system).
4.  Review the "Watchlist" (prepares the strategic mind).
5.  Visualizing the trade (prepares the psychological mind).
...
**Entry/Exit Criteria:** Exact definitions of when to get in and out.
**Max Loss Limit:** The absolute dollar amount at which you shut down your computer.

## Real-World Examples
The authors describe a "cowboy" trader who trades whatever is moving. One day they trade Tesla, the next a penny stock, the next crypto. They have no consistency.
Contrast this with the "sniper." The sniper only trades VWAP Reversals on Large Cap tech stocks between 9:30 and 10:30 AM. If that setup doesn't happen, they don't trade. The sniper makes a living; the cowboy goes broke.
...
## Key Terminology
**Drawdown:** The peak-to-trough decline in an account.
**Revenge Trading:** Trying to make back a loss immediately, usually with increased size and aggression.
**Desensitization:** Reaching a point where a loss is just data, not emotional pain.

## Real-World Examples
The authors discuss the "Blow Up." A trader loses big. They feel shame. They hide the loss from their spouse. They deposit more money to "fix it."
The correct response (The Prop Mindset): The trader accepts the loss as the "Cost of Goods Sold" (COGS). They analyze the data. Was it a bad setup or bad luck? If it was a bad setup, they learn. If it was bad luck, they shrug. They do not internalize the financial loss as personal failure.

## Actionable Exercises
**The Post-Mortem Review**
After every trading session, answer:
1.  What did I do well? (Reinforce good habits).
2.  What did I do poorly? (Identify bad habits).
3.  Did I follow the plan? (Yes/No).
...
1.  **Identify the Bias:** Acknowledge you are biologically wired to fail (Chapter 3).
2.  **Build the Infrastructure:** Use habits, routines, and physical contracts (Trading Plans) to bypass your biology (Chapters 6 & 7).
3.  **Manage the Resource:** Treat Mental Capital as more precious than Financial Capital (Chapter 5).
