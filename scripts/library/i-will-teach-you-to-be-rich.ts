...
export const book: BookDefinition = {
    ...
    summary: `# The Implementation Guide: The No-BS Roadmap to Automating Your Money
...
| Category | Recommended % | What belongs here? |
| :--- | :--- | :--- |
| **1. Fixed Costs** | 50-60% | Rent/Mortgage, Utilities, Debt Payoff, Groceries, Insurance. |
| **2. Investments** | 10% | 401(k), Roth IRA. This is for "Future You." |
| **3. Savings** | 5-10% | Emergency Fund, Wedding, House Down Payment, Travel goals. |
| **4. Guilt-Free Spending** | 20-35% | Dining out, clothes, drinks, gadgets. Anything you want. |
