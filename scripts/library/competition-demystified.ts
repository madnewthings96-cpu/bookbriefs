...
export const book: BookDefinition = {
    ...
    summary: `# Master Class: Advanced Corporate Strategy & Valuation
**Course Lead:** Professor of Finance (Columbia Business School Style)
**Subject:** Deconstructing *Competition Demystified* by Greenwald & Kahn
...
| Scenario | Outcome |
| :--- | :--- |
| **No Barriers** | New competitors enter whenever ROIC > WACC. Supply increases, prices fall, and returns revert to the cost of capital. |
| **With Barriers** | Incumbents can sustain "super-normal" profits because competitors cannot enter to drive down prices. |
...
| Feature | Operational Efficiency | Strategy |
| :--- | :--- | :--- |
| **Context** | Markets **without** barriers (Commodities) | Markets **with** barriers (Franchises) |
| **Action** | Cutting costs, running faster, better marketing | Managing the moat, pricing, cooperative behavior |
| **Sustainability** | Low (Competitors copy you) | High (Protected by structural advantages) |
| **Example** | Toaster Manufacturer | Microsoft (1990s), Coca-Cola |
...
| Feature | Cement Company (Local) | PC Manufacturer (Global) |
| :--- | :--- | :--- |
| **Product** | Heavy, cheap (high transport cost) | Light, high-value (low transport cost) |
| **Market Radius** | 50 miles around the plant | The entire world |
| **Competition** | Local Monopoly (often 1 player) | Global Oligopoly (HP, Dell, Apple, etc.) |
| **Moat Strength** | **Strong** (New entrant doubles supply, crashes price) | **Weak** (Market is too vast to dominate) |
...
| Company A \ B | Cooperate (High Price) | Defect (Cut Price) |
| :--- | :--- | :--- |
| **Cooperate** | **Win/Win** ($100m / $100m) | **Lose/Win** ($0 / $150m) |
| **Defect** | **Win/Lose** ($150m / $0) | **Lose/Lose** ($10m / $10m) |
...
| Scenario | Comparison | Diagnosis | Strategy |
| :--- | :--- | :--- | :--- |
| **A** | **EPV < Assets** | Value Destruction | Liquidate or Activist Takeover |
| **B** | **EPV = Assets** | Competitive Industry | Operational Efficiency Only |
| **C** | **EPV > Assets** | **Franchise (Moat)** | **Strategy & Growth** |
...
3.  **Local > Global**: Dominate your niche.
4.  **Avoid Price Wars**: Compete on image or features.
5.  **EPV > DCF**: Value what exists, not what might happen.
6.  **The Discipline of "No"**: Don't enter markets where you can't win. Don't grow for growth's sake.
